...
keys.globalkeys = gears.table.join(
    ...
    awful.key({ superkey }, "q", function() apps.terminator() end,
        {description = "terminator", group = "terminator"}),
    ...
    -- Editor apps.editor desc = editor group = launcher
    awful.key({ superkey }, "e", apps.sublime,
        {description = "sublime", group = "sublime"}),
