...
apps.editor = function ()
    helpers.run_or_raise({instance = 'editor'}, false, user.editor, { switchtotag = false })
      -- helpers.scratchpad({instance = 'editor'}, user.editor)
end
...
-- here
apps.sublime = function()
    helpers.scratchpad({instance = "sublime"},user.sublime)
end
apps.terminator = function()
    helpers.scratchpad({instance = "terminator"},user.terminator)
end
apps.music = function ()
